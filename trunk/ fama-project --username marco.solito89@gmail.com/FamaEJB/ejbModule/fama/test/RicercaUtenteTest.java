...
public class RicercaUtenteTest extends FamaTest{
	...
	public void testRicercaUtente() {
		//registra 3 utenti
		rbr.registraUtente("tester", "tester", "tester", "tester", "tester", "tester");
		...
		try {
			//effettua il login con un utente esterno alla ricerca
			accessoBeanRemote.login("tester", "tester");
			// effettua ricerca per username nome cognome
			ArrayList<UtenteRegistratoObj> arrayUtRegObj = (ArrayList<UtenteRegistratoObj>) accessoBeanRemote.ricercaUtente("chiaveRicerca");
